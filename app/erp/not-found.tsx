  ...
  return (
    <div className="flex items-center justify-center py-24">
      <div className="max-w-md w-full text-center kimichi-card p-8">
        ...
        <p className="text-sm text-slate-400 mb-6">الرابط الذي حاولت الوصول إليه غير موجود في النظام.</p>
        <Link href="/erp/dashboard" className="btn-primary inline-flex">العودة للوحة التحكم</Link>
      </div>
    </div>
  );
}
